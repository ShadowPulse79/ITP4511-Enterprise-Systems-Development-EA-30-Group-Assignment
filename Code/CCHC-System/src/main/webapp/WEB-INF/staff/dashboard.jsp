...
<div class="navbar">
    <div class="logo">🏥 CCHC 社区诊所系统（员工）</div>
    <div class="nav-right">
...
<div class="container">
    <div class="welcome-card">
        <h2>欢迎回来，<%= fullName != null ? fullName : "员工" %>！</h2>
        <p>欢迎使用 CCHC 社区诊所管理系统，您可以在这里管理预约、排队和通知。</p>
        <% if (unreadCount > 0) { %>
    ...
    <div class="feature-grid">
        <div class="feature-card" onclick="location.href='${pageContext.request.contextPath}/appointment/manage'">
            <div class="feature-icon">📅</div>
            <div class="feature-title">预约管理</div>
            <div class="feature-desc">查看和处理患者预约</div>
        </div>
        <div class="feature-card" onclick="location.href='${pageContext.request.contextPath}/queue/manage'">
            <div class="feature-icon">🚶</div>
            <div class="feature-title">排队管理</div>
            <div class="feature-desc">管理当天就诊排队</div>
        </div>
